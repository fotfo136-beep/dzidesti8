...
export default function LoginPage() {
  ...
  const isFirebaseConfigured = defaultFirebaseConfig.apiKey !== "YOUR_API_KEY";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center p-4">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Firebase Not Configured</h1>
          <p className="text-gray-600 mb-6">
            To enable cloud sync, you need to set up Firebase.
          </p>
          <div className="bg-gray-100 rounded-lg p-4 text-left mb-4">
            <h3 className="font-semibold text-gray-700 mb-2">Quick Setup:</h3>
            <ol className="text-sm text-gray-600 space-y-1 list-decimal list-inside">
              ...
              <li>Enable Authentication (Email & Google)</li>
              <li>Create a Firestore database</li>
              <li>Copy your config to a .env file</li>
            </ol>
          </div>
          <div className="bg-gray-50 rounded-lg p-4 text-left">
            <p className="text-xs text-gray-500 font-mono mb-2">Create a file called <code className="bg-gray-200 px-1 rounded">.env.local</code>:</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Estim8</h1>
